...
//
//         Lesson l1 = new Lesson("Opening class", "opening-of-the-event", "Class for initializer trigger on python advanced", "p_heym7pmEk", Instant.parse("2025-09-21T19:00:07Z"), 1L , 1L, LessonType.LIVE);
//         Lesson l2 = new Lesson("Python Recognition", "facial-recognition-class", "Locate faces within an image or video stream. This typically involves using pre-trained models like Haar Cascades or more advanced deep learning models.", "MYPVQccHhAQ", Instant.parse("2025-09-22T19:00:07Z"), 2L , 1L, LessonType.RECORD);
