...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Lesson l2 = new Lesson("Python Recognition", "class 2", "Locate faces within an image or video stream. This typically involves using pre-trained models like Haar Cascades or more advanced deep learning models.", "p_heym7pmEk", Instant.parse("2025-09-22T19:00:07Z"), 1L , 2L, LessonType.LIVE);
